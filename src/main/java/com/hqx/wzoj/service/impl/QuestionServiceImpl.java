 ...
 * @createDate 2023-12-17 17:56:54
 */
@Service
@Slf4j
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    /**
     * 获取查询包装类 （用户根据哪些字段查询，根据前端传来的请求对象，得到 MybatisPlus 支持的查询 QueryWrapper 类）
     *
